...
impl ProvisionTaskError {
    ...
    ///
    /// ```rust
    /// # use torrust_tracker_deploy::e2e::tasks::virtual_machine::run_provision_command::ProvisionTaskError;
    /// # use torrust_tracker_deploy::domain::environment::state::StateTypeError;
