...
"#
    ...
    fn it_should_create_prometheus_template_successfully() {
        ...
        let ctx = PrometheusContext::new(15, "test_token".to_string(), 1212);
    ...
    fn it_should_render_template_with_context() {
        let template_content = sample_template_content();
        let ctx = PrometheusContext::new(30, "admin_token".to_string(), 8080);
    ...
    fn it_should_not_contain_template_syntax_after_rendering() {
        let template_content = sample_template_content();
        let ctx = PrometheusContext::new(15, "token".to_string(), 1212);
    ...
    fn it_should_render_to_file_successfully() {
        ...
        let template_content = sample_template_content();
        let ctx = PrometheusContext::new(20, "file_token".to_string(), 9090);
    ...
    fn it_should_provide_access_to_context() {
        let template_content = sample_template_content();
        let ctx = PrometheusContext::new(25, "context_token".to_string(), 7070);
