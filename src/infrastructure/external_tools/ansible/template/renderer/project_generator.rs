...
use crate::infrastructure::external_tools::ansible::template::renderer::inventory::{
    InventoryRenderer, InventoryRendererError,
};
use crate::infrastructure::external_tools::ansible::template::renderer::variables::{
...
impl AnsibleProjectGenerator {
    ...
    >{
        ...
        AnsibleVariablesContext::new(inventory_context.ansible_port()).map_err(|e| {
            AnsibleProjectGeneratorError::ContextCreationFailed {
