//! Template wrapper for templates/tofu/lxd/README.md

use crate::template::{StaticContext, TemplateRenderer};
use anyhow::Result;
use std::path::{Path, PathBuf};

/// Template wrapper for templates/tofu/lxd/README.md (static documentation)
...
impl TemplateRenderer for ReadmeTemplate {
