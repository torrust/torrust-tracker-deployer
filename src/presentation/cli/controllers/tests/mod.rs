...
//!
//! ```ignore
//! use torrust_tracker_deployer_lib::presentation::cli::controllers::tests::{TestContext, create_valid_config};
//!
//! fn example_usage() {
...
///
/// ```ignore
/// use torrust_tracker_deployer_lib::presentation::cli::controllers::tests::TestContext;
///
/// fn example_usage() {
///     let context = TestContext::new();
///     
...
/// ```ignore
/// use tempfile::TempDir;
/// use torrust_tracker_deployer_lib::presentation::cli::controllers::tests::create_valid_config;
///
...
/// ```ignore
/// use tempfile::TempDir;
/// use torrust_tracker_deployer_lib::presentation::cli::controllers::tests::create_invalid_json_config;
///
/// let temp_dir = TempDir::new().unwrap();
...
/// ```ignore
/// use tempfile::TempDir;
/// use torrust_tracker_deployer_lib::presentation::cli::controllers::tests::create_config_with_invalid_name;
///
/// let temp_dir = TempDir::new().unwrap();
...
/// ```ignore
/// use tempfile::TempDir;
/// use torrust_tracker_deployer_lib::presentation::cli::controllers::tests::create_config_with_missing_keys;
///
/// let temp_dir = TempDir::new().unwrap();
...
///
/// ```ignore
/// use torrust_tracker_deployer_lib::presentation::cli::controllers::tests::{TestContext, default_global_args};
///
/// let context = TestContext::new();
...
pub fn default_global_args(
    working_dir: &Path,
) -> crate::presentation::cli::input::cli::args::GlobalArgs {
