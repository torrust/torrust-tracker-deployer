...
impl From<ViewRenderError> for RegisterSubcommandError {
...
impl RegisterSubcommandError {
    ...
    ///
    /// ```rust
    /// use torrust_tracker_deployer_lib::presentation::cli::controllers::register::errors::RegisterSubcommandError;
    ///
