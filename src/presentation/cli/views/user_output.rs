...
impl UserOutput {
    ...
    ///
    /// ```rust,ignore
    /// use torrust_tracker_deployer_lib::presentation::cli::views::{UserOutput, VerbosityLevel, ProgressMessage};
    ///
    /// let mut output = UserOutput::new(VerbosityLevel::Normal);
...
mod tests {
    ...
    mod verbosity {
        ...
        use crate::presentation::cli::views::Channel;
    ...
    mod formatter {
        use super::*;
        use crate::presentation::cli::views::formatters::JsonFormatter;
        use crate::presentation::cli::views::testing::TestWriter;
        use crate::presentation::cli::views::Channel;
