...
//!
//! This module contains view components for rendering destroy command output.
//!
//! # Architecture
//!
//! This module follows the Strategy Pattern for rendering:
//! - `DestroyDetailsData`: The data DTO passed to all views
...
//!   - `destroy_details.rs`: Main DTO with environment destroy data
...
//! 2. Implement the view with `render(data: &DestroyDetailsData) -> String`
//! 3. Export it from this module
//! 4. No need to modify existing views or the DTO

pub mod view_data {
    pub mod destroy_details;

    // Re-export main types for convenience
    pub use destroy_details::DestroyDetailsData;
}
...
pub use view_data::DestroyDetailsData;
