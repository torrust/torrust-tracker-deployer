...
impl TextView {
    /// Render destroy details as human-readable formatted text
    ///
    /// Takes destroy details and produces a human-readable output
    ...
    /// - Instance IP (if available, otherwise "Not available")
    /// - Creation timestamp
    ///
    /// # Format
    ///
