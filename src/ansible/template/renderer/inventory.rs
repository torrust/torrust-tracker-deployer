...
//! use torrust_tracker_deploy::ansible::InventoryTemplateRenderer;
//! use torrust_tracker_deploy::template::TemplateManager;
//! use torrust_tracker_deploy::template::wrappers::ansible::inventory::InventoryContext;
//!
...
mod tests {
    ...
    use crate::template::wrappers::ansible::inventory::{AnsibleHost, SshPrivateKeyFile};
