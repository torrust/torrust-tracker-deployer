//! End-to-End Infrastructure Lifecycle Tests for Torrust Tracker Deployer
//!
...
//! ## Usage
//!
//! Run the E2E infrastructure lifecycle tests:
//!
//! ```bash
...
//! cargo run --bin e2e-infrastructure-lifecycle-tests -- --log-format json
//!
//! # Show help
//! cargo run --bin e2e-infrastructure-lifecycle-tests -- --help
//! ```
//!
//! ## Test Workflow
//!
...
// Constants for the e2e-infrastructure environment
const ENVIRONMENT_NAME: &str = "e2e-infrastructure";

#[derive(Parser)]
#[command(name = "e2e-infrastructure-lifecycle-tests")]
#[command(about = "E2E infrastructure lifecycle tests for Torrust Tracker Deployer")]
struct Cli {
...
fn main() -> Result<()> {
    ...
    LoggingBuilder::new(std::path::Path::new("./data/e2e-infrastructure/logs"))
    ...
    info!(
        ...
        test_suite = "e2e_infrastructure_lifecycle_tests",
