...
//! Docker containers instead of VMs. Unlike `e2e_config_tests`, this test uses a black-box
//! approach, executing CLI commands as external processes rather than importing internal
//! application logic.
//!
//! ## Usage
//!
...
//!
//! ```bash
//! cargo run --bin e2e-config-tests-new
//! ```
//!
...
//! cargo run --bin e2e-config-tests-new -- --log-format json
//!
//! # Show help
//! cargo run --bin e2e-config-tests-new -- --help
//! ```
//!
//! ## Test Workflow
//!
...
//!
//! - **Black-box** (this test): Executes CLI commands as external processes, testing the
//!   full user-facing interface. Better for integration and acceptance testing.
//! - **White-box** (`e2e_config_tests`): Imports and calls internal handlers directly.
//!   Better for debugging and detailed step verification.
//!
...
const ENVIRONMENT_NAME: &str = "e2e-config-new";

#[derive(Parser)]
#[command(name = "e2e-config-tests-new")]
...
pub async fn main() -> Result<()> {
    ...
    info!(
        ...
        test_suite = "e2e_config_tests_new",
