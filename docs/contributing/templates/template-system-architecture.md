...
### Template Metadata Infrastructure
...
- `generated_at: DateTime<Utc>` - ISO 8601 timestamp
- Injected via `Clock` service in project generators
- Consistent across all templates in a deployment

### YAML Header Placement Convention
...
**Rationale**: The `---` marker indicates the start of a YAML document. The header contains metadata about the file, not YAML content. See [YAML Template Conventions](yml.md) for details.

### Related Documentation

- [YAML Template Conventions](yml.md) - YAML-specific header placement and patterns
- [Tera Template Variable Syntax](tera.md) - Template variable syntax and best practices
- [Issue #308](../../issues/308-add-ai-discoverable-documentation-headers-to-templates.md) - Implementation details
