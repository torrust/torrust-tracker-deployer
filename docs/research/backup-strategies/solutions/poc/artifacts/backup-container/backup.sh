...
# Orchestrates the backup sidecar lifecycle.
#
# Validates configuration, prints startup info, runs an immediate backup,
# then enters an infinite loop running backups at the configured interval.
#
# Side Effects:
...
#
# Displays: interval, retention days, MySQL enabled state, paths file location.
print_configuration() {
...
#
# Returns:
#   BACKUP_INTERVAL or 120 (default)
get_interval() {
