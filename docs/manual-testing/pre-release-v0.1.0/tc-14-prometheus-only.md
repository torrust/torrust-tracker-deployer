...
**Environment name**: `pre-release-test-14`
**Config file**: `envs/pre-release-test-14.json`
...
| ------------------------ | -------------------- | ------- | ----- |
| docker ps (containers)   | tracker, prometheus  | pending |       |
...
| Grafana port 3000        | NOT listening        | pending |       |
