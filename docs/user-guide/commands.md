...
The create, provision, and destroy commands support these common options:

- `--help` - Display command help
- `--output-format <FORMAT>`, `-o` - Output format for command results (`text` or `json`, default: `text`)
