...
#   Template:      templates/tofu/lxd/main.tf
#   API Docs:      https://docs.rs/torrust-tracker-deployer/latest/
#
# DESCRIPTION:
#   OpenTofu main configuration for LXD provider.
#   Defines VM instances, profiles, storage, and networking for local LXD deployments.
#
